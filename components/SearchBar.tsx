        ...
        <DialogHeader>
          ...
          <form className="relative" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              type="submit"
              title="Search"
              className={`absolute right-0 top-0 w-10 h-full flex items-center justify-center rounded-tr-md rounded-br-md hover:bg-[#151515] hover:text-white hoverEffect ${search ? "bg-[#151515] text-white" : "bg-[#151515]/10"}`}
            >
                ...
                >
                  <div className="flex items-center p-1">
                    <Link
                      ...
                      className="h-20 w-20 md:h-24 md:w-24 flex-shrink-0 border border-[#151515]/20 rounded-md overflow-hidden group"
