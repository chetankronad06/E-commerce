...
import NoProductsAvailable from "./NoproductsAvail";
interface Props {
            ...
            <div className="flex flex-col md:min-w-40 border">
                {categories?.map((item) => (
                    <Button
                        ...
                        className={`bg-transparent border-0 rounded-none text-[#151515] shadow-none hover:bg-[#151515]/80 hover:text-white font-semibold hoverEffect border-b last:border-b-0 ${item?.slug?.current === currentSlug && "bg-[#151515] text-white border-[#151515]"}`}
                    >
                        {item?.title}
                    </Button>
                ))}
